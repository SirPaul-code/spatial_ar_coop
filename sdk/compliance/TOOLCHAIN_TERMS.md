...
of the agreement's broad SDK wording. A name change from SDK to library would
not resolve a contractual issue. Before commercial SDK distribution, obtain legal
review or clarification for the actual artefacts, toolchain components and chosen
distribution model, including which components fall under section 3.5.
